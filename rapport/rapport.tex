...
Deux composantes sont à distinguer, l'effet SZ thermique et
l'effet SZ cinétique. La deuxième composante est simplement dù à un effet
Doppler additionnel. 
...
La figure \ref{w_full} nous montre, pour chaque fréquence, le poids
...
\fxwarning{tri des amas + dernier plot}
Nous allons en particulier
