...
\begin{figure}[h!]
  \centering
  \label{w_full}
  \includegraphics[width=6in]{w_full.pdf}
...
de l'algorithme que nous utilisons pour determiner le rayon critique de nos source. Cependant par manque de temps
 ...
 \end{equation}
 Où $Pr$ désigne le profile radiale de la source. 
...
\end{equation}
L'érreur que nous commetons ainsi sur la valeur de $r_c$ est de au plus 1 pixel et est asymetrique.
